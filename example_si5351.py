...
si5351.pll_a.configure_fractional(24, 2, 3)  # Multiply 25mhz by 24.667 (24 2/3)
...
print("Clock 0: {0}mhz".format(si5351.pll_a.frequency/ 8000000))
time.sleep(0.5)
...
print("Clock 1: {0}mhz".format(si5351.pll_b.frequency / (45.5*1000000)))
time.sleep(0.5)
...
#si5351.clock_2.r_divider = adafruit_si5351.R_DIV_2
print("Clock 2: {0}khz".format(si5351.pll_b.frequency / 900000))
